...
(use-package prettier-js
  ...
  :config (progn
            ...
            (setq prettier-js-args '("--print-width" "100" "--semi" "false" "--trailing-comma" "all" "--single-quote" "true"))))
...
(use-package mocha
  :ensure t
  :config (progn
            (add-hook 'rjsx-mode-hook (local-set-key [?\M-\r] 'mocha-test-at-point))
            (add-hook 'js2-mode-hook (local-set-key [?\M-\r] 'mocha-test-at-point))))
...
;; ;; assumes you have run instructions here:  https://github.com/flowtype/flow-for-emacs
;; (load-file "~/.emacs.d/personal/lang/flow-for-emacs/flow.el")
